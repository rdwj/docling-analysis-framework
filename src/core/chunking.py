...
class DoclingChunkingStrategy(ABC):
    ...
    @abstractmethod
    def chunk_document(self, file_path: str, markdown_content: str, docling_result: Any, specialized_analysis: Optional[Dict[str, Any]] = None) -> List[DocumentChunk]:
...
class StructuralChunkingStrategy(DoclingChunkingStrategy):
    ...
    def _split_large_section(self, section: Dict[str, Any], start_index: int) -> List[DocumentChunk]:
...
class DoclingChunkingOrchestrator:
    ...
    def __init__(self, max_file_size_mb: Optional[float] = None, config: Optional[ChunkingConfig] = None, max_chunk_size: int = 2000, overlap_size: int = 200):
    ...
    def _determine_strategy(self, specialized_analysis: Optional[Dict[str, Any]], markdown_content: str) -> str:
    ...
    def chunk_document(self, file_path: str, markdown_content: str, docling_result: Any, specialized_analysis: Optional[Dict[str, Any]] = None, strategy: str = 'auto', config: Optional[ChunkingConfig] = None) -> List[DocumentChunk]:
        """
        ...
        try:
            ...
            # Chunk the document
            chunks = chunking_strategy.chunk_document(file_path, markdown_content, docling_result, specialized_analysis)
